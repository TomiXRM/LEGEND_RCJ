...
void Motors::driveVector(VectorXY vec,float Output,bool useCam){
        float M1 = vec.x* -0.7071 + vec.y* -0.7071 + Output*useCam;
        float M2 = vec.x* 0.7071 + vec.y* -0.7071 + Output;
        float M3 = vec.x* 0.7071 + vec.y* 0.7071 + Output*useCam;
        float M4 = vec.x* -0.7071 + vec.y* 0.7071 + Output;
