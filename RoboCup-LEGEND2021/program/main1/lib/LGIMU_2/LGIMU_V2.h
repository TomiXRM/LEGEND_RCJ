...
#include "mbed.h"
//
#define BNOAddress (0x29 << 1)//GY-BNO055=0x29,Normal=0x28
...
float filterCoefficient_X;
float filterCoefficient_Y;
float filterCoefficient_R;
...
float timeSpan;
// ひとつ前の加速度
float oldAccel_X,oldAccel_Y,oldAccel_R;
//　加速度から算出した速度
float speed_X,speed_Y,speed_R;
// ひとつ前の速度
float oldspeed_X,oldspeed_Y,oldspeed_R;
// 速度から算出した変位
float difference_X,difference_Y,difference_R;
