...
// LGLCD::LGLCD(PinName SDA,PinName SCL) : i2c(SDA,SCL),base(i2c,NC,0x78,64,128){
LGLCD::LGLCD(I2C &_i2c) : i2c(_i2c), base(_i2c,NC,0x78,64,128){
        //   i2c.frequency(500000);//400kHz
        base.clearDisplay();
...
void LGLCD::setTextSize(float size){
...
void LGLCD::Ballrt(uint8_t r,int16_t t){
