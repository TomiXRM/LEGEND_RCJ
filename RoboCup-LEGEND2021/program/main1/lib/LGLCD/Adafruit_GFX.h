...
void drawChar(int16_t x, int16_t y, unsigned char c, uint16_t color, uint16_t bg, float size);
...
inline void setTextColor(uint16_t c) {
        textcolor = c; textbgcolor = c;
}
/// Set the text foreground and background colors independantly
inline void setTextColor(uint16_t c, uint16_t b) {
        textcolor = c; textbgcolor = b;
};
