...
void Motors::run(float p1,float p2,float p3,float p4){
        //p1,p2,p3,p4 are u_sing -100 to 100 numbers.
        slp = 1;
        m1=((p1/2)+50)/100;
        m2=((p2/2)+50)/100;
        m3=((p3/2)+50)/100;
...
int Motors::drive(int deg,float power,float degree){
        ...
        /*p1 =((_sin((deg + Deg_m1) * PI / 180) * power)/2)+0.5+((degree/2)+50)/100;
           p2 =((_sin((deg + Deg_m2) * PI / 180) * power)/2)+0.5+((degree/2)+50)/100;
           p3 =((_sin((deg + Deg_m3) * PI / 180) * power)/2)+0.5+((degree/2)+50)/100;
           p4 =((_sin((deg + Deg_m4) * PI / 180) * power)/2)+0.5+((degree/2)+50)/100;*/

        p1 = (_sin((deg + Deg_m1)) * power)+degree;
        p2 = (_sin((deg + Deg_m2)) * power)+degree;
        p3 = (_sin((deg + Deg_m3)) * power)+degree;
        p4 = (_sin((deg + Deg_m4)) * power)+degree;
        run(p1,p2,p3,p4);
