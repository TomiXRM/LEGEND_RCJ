...
MovingAverage smaMaxPulse(10);
MovingAverage smaDist(10);
...
INLINE void ballread() {
        ...
        if(Max_Sen != 20) {
                ...
                if(Max_Sen == 0) {//0
                        //degree = 0;
                        if(smaIRdistance>345) {//1と2の境界
                                ir=1000;//ちかい
                        }else if(smaIRdistance>325) {//2と3の境界
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>300) {//3と4の境界
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {//4（少なくともボールある)と5(そもそもボールがねぇ)の境界
                        ...
                        //degree = -22.5;
                        if(smaIRdistance>478) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>446) {
                                ir=2000;//まあちかい
                        ...
                        //degree = 22.5;
                        if(smaIRdistance>465) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>443) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>280) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                                ir=4000;//めちゃくちゃ遠い
                        }else{
                        ...
                        degree = 45;
                        if(smaIRdistance>449) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>435) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>280) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                        ...
                        degree = -67.5;
                        if(smaIRdistance>447) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>399) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>320) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                                ir=4000;//めちゃくちゃ遠い
                        }else{
                        ...
                        degree = 90;
                        if(smaIRdistance>385) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>385) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>330) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                        ...
                        degree = -112.5;
                        if(smaIRdistance>416) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>380) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>345) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                                ir=4000;//めちゃくちゃ遠い
                        }else{
                        ...
                        degree = -135;
                        if(smaIRdistance>335) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>314) {
                                ir=2000;//まあちかい
                        ...
                        //TODO ここだけは下がったら数値上がったりするんで別の仕組みが必要かも。
                        degree = -157.5;
                        if(smaIRdistance>281) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>220) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>200) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                                ir=4000;//めちゃくちゃ遠い
                        }else{
                        ...
                        degree = 157.5;
                        if(smaIRdistance>400) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>360) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>200) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                        ...
                        degree = 180;
                        if(smaIRdistance>270) {
                                ir=1000;//ちかい
                        }else if(smaIRdistance>260) {
                                ir=2000;//まあちかい
                        }else if(smaIRdistance>180) {
                                ir=3000;//かろうじて近い
                        }else if(smaIRdistance>1) {
                                ir=4000;//めちゃくちゃ遠い
                        }else{
