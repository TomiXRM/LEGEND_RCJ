...
Motor::Motor(PinName MD1,PinName PWM1,PinName MD2,PinName PWM2,PinName MD3,PinName PWM3,PinName MD4,PinName PWM4) :
        _PWM1(PWM1),_MD1(MD1),_PWM2(PWM2),_MD2(MD2),_PWM3(PWM3),_MD3(MD2),_PWM4(PWM4),_MD4(MD4){
...
void Motor::tweak(char par1,char par2,char par3,char par4){
        M1SA = par1/100;
        M2SA = par2/100;
        M3SA = par3/100;
        M4SA = par4/100;
